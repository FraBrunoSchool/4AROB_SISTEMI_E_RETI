...
2. If you are not sure, ask someone for help or search online. Many times searching for ”python3.6 THING” will find
   answers to what that THING does in Python. Try searching for ”python3.6 open.”
3. I used the word ”commands” here, but commands are also called ”functions” and ”methods.” You will learn about
   functions and methods later in the book.
...
6. Start python3.6 to start the python3.6 shell, and use open from the prompt just like in this program. Notice how you
